...
router.post('/issues/:issueid/responsible_party_notification', sanitizeInput, auth, ctrlIssues.sendResponsiblePartyNotification);
...
router.post('/communities/resurrect/resident', sanitizeInput, auth, ctrlResidents.resurrectResident);
